    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-primary">View News</h5>
          ...
          <form id='newsForm' enctype="multipart/form-data" onsubmit="return checkFormInput(this.id)" name="newsForm" method="post" action="">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                <label for="viewTitle" class="text-primary">Title</label>
                <p id='viewTitle'></p>
              </div>
              <div class="form-group col-md-3">
                <label for="viewDate" class="text-primary">Date of Publish</label>
                <p id="viewDate"></p>
              </div>
              <div class="form-group col-md-3">
                <label for="viewStatus" class="text-primary">Status</label>
                <p id='viewStatus'></p>
              </div>
            </div>
            <div class="form-group">
              <label for="viewDetails" class="text-primary">News Details</label>
                <p id='viewDetails'></p>
            </div>
        </div>
 ...
 <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body m-3">
          <form id='notepadForm' enctype="multipart/form-data" onsubmit="return checkFormInput(this.id)" name="notepadForm" method="post" action="actions/newsManagement.php">
            <div class="form-row">
              <div class="form-group col-md-7">
                <label for="title">Title</label>
                <input type="text" name="title" class="form-control" id="editTitle" placeholder="Edit Title...">
                <input type="hidden" name="newsid" class="form-control" id="editNewsid" >
              </div>
          ...
          <form id='notepadForm' enctype="multipart/form-data" onsubmit="return checkFormInput(this.id)" name="notepadForm" method="post" action="actions/newsManagement.php">
            <div class="form-row">
              <div class="form-group col-md-12">
                <p for="newsTitle" id="deleteNewsTitle" class="text-primary text-center"></p>
                <input type="hidden" name="newsid" class="form-control" id="deleteNewsid" >
              </div>
            </div>
            <div class="form-group">
              <p for="message" class="text-danger text-center">Message</p>
              <h5 class="text-center">If you press Confirm Delete, the News will be permenently Deleted!</h5>
            </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</button>
          <button type="submit" name="deleteNews" class="btn btn-danger"><i class="fas fa-trash"></i> Confirm Delete</button>
          </form>
        </div>
      </div>
    </div>
  ...
  <div class="modal fade" id="profilePictureModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Edit News Photo!</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body m-3">
          <form id='profilePictureForm' enctype="multipart/form-data" onsubmit="return checkFormInput(this.id)" name="profilePictureForm" method="post" action="actions/newsManagement.php">
            <div class="form-row profile-content text-center">
              ...
              <input type="hidden" name="newsid" class="form-control" id="pictureNews" >
            ...
            <div class="form-group">
              ...
              <input type='text' style="text-align: center;" name="title" class="form-control pictureNames" id="newsTitle" placeholder="Title...." readonly>
            </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</button>
