            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-center text-white font-weight-medium">Human Rights Program</h4>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-center text-white font-weight-medium">Advocacy and Awareness</h4>
                            <!-- <span>100 Courses</span> -->
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-center text-white font-weight-medium">Academic Engagement</h4>
                            <!-- <span>100 Courses</span> -->
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-center text-white font-weight-medium">Community Integration and Development</h4>
                            <!-- <span>100 Courses</span> -->
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-center text-white font-weight-medium">Sexual Education</h4>
                            <!-- <span>100 Courses</span> -->
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-center text-white font-weight-medium">Community Health Program</h4>
                            <!-- <span>100 Courses</span> -->
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-center text-white  font-weight-medium">HIV/AIDS and STI Prevention</h4>
                            <!-- <span>100 Courses</span> -->
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-center text-white font-weight-medium">Nutrition and Welfare Workshops</h4>
                            <!-- <span>100 Courses</span> -->
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="cat-item position-relative overflow-hidden rounded mb-2">
                        <img class="img-fluid" src="img/cat-8.jpg" alt="">
                        <a class="cat-overlay text-white text-decoration-none" href="">
                            <h4 class="text-center text-white font-weight-medium">Non-Communicable Diseases Awareness</h4>
                            <!-- <span>100 Courses</span> -->
                        </a>
                    </div>
                </div>
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="mb-4">
                        <h5 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Membership Application</h5>
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body rounded-bottom bg-primary p-5">
                            <form>
                                ...
                                <div>
                                    <a href="membership.php" class="btn btn-primary btn-block border-0 py-3" type="submit">Apply Now</a href="membership.php">
                                </div>
                            </form>
                        </div>
                    </div>
...
<!-- <div class="container-fluid" style="padding: 80px 0;border:solid 2px red;">sasa
 		<div class="container"style="border:solid 2px red;">
 			<div class="row">
 				<div class="col-md-12">
 					<div class="logo-carousel partnerowl-carousel">
